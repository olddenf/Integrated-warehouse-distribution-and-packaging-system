    ...
    <van-scroll-view class="scroll-view" scroll-y>
      <div class="detail-content">
        ...
        <div class="action-buttons">
          <van-button type="primary" class="action-button" @click="handleStart" v-if="task.status === 'pending'">开始卸货</van-button>
          <van-button type="primary" class="action-button" @click="handleComplete" v-else-if="task.status === 'in_progress'">完成卸货</van-button>
        </div>
      </div>
    </van-scroll-view>
  </div>
...
const statusText = computed(() => {
  switch (taskStatus.value) {
    case 'pending': return '待卸货';
    case 'in_progress': return '卸货中';
